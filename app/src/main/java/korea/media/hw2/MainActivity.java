            ...
            public boolean onTouch(View view, MotionEvent motionEvent)
            {
                ...
                switch (motionEvent.getAction())
                {
                    case MotionEvent.ACTION_DOWN :
                        ...
                        mouseDownEvents(motionEvent.getX(), motionEvent.getY(), doubleTouch);
                        break;

                    case MotionEvent.ACTION_MOVE :
                        mouseMoveEvents(motionEvent.getX(), motionEvent.getY(), doubleTouch);
                        break;

                    case MotionEvent.ACTION_UP :
                        mouseUpEvents(motionEvent.getX(), motionEvent.getY(), doubleTouch);
                        break;
                }
                return true;
            }
